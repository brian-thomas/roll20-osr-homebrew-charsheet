...
on('chat:message', function(msg) {
	...
	log("RL template msg:"+msg.content);
        var cnamebase = msg.content.split("charname=")[1];
	log("RL Cnamebase:"+cnamebase);
	...
	log("RL Character:"+character);
	log("RL template:"+msg.rolltemplate);
        ...
        if(["dmg","atkdmg"].indexOf(msg.rolltemplate) > -1) {
            log("RL atkdmg, dmg reached");
            log("RL inlinerolls:"+_.has(msg,'inlinerolls'));
...
var handleslotattack = function (msg,character,player) {
    log("RL Handleslotattack reached msg:"+msg);
...
var resolveslot = function(msg,character,player,spellslot) {
    log("RL Resolvesslot reached spellslot:"+spellslot);
